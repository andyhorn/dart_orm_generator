...
class WhereNotExpressionBuilder extends CodeBuilder {
  WhereNotExpressionBuilder(this.className);

  final String className;

  static String generateClassName(String className) => '${className}WhereNOT';
